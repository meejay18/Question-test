...
export const MainQuestion = () => {
  ...
  const [timing, setTiming] = useState<number>(200);
  ...
  return (
    <div className="flex gap-4 justify-between mt-20 px-5 h-[800px]">
      <div
        className={`text-[20px] h-[50px] w-[50px] rounded-full bg-slate-100 flex justify-center items-center shadow-inner border ${
